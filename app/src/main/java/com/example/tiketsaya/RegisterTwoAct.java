    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String conNamaLengkap = nama_lengkap.getText().toString();
                String conBio = bio.getText().toString();

                if (conNamaLengkap.isEmpty()){
                ...
                else if (conBio.isEmpty()){
                    Toast.makeText(getApplicationContext(),"Masukkan Peminatan atau Pekerjaan Anda",Toast.LENGTH_SHORT).show();
                    //after clicked disable
                    btn_continue.setEnabled(true);
                    btn_continue.setText("Continue");
                }
