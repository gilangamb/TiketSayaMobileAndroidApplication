...
public class MyProfileAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_my_ticket_01 = findViewById(R.id.btn_my_ticket_01);
        ...
        btn_edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotoeditmyticket = new Intent(MyProfileAct.this,EditMyProfile.class);
                startActivity(gotoeditmyticket);
            }
        });
...
//                menghapus atau menghilangkan value dari username local
...
//                berpindah activity
                Intent gotoeditmyticket = new Intent(MyProfileAct.this,SignInAct.class);
                startActivity(gotoeditmyticket);
                finish();
            }
        });
